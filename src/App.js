...
function App()
{
    ...
    function getData()
    {
        var weather = axios(`https://api.openweathermap.org/data/2.5/weather?q=${enteredvalue}&appid=0e7d7a3c46860ca0083efbe70162c429`)
    ...
    return (<div className="flex flex-row justify-center h-[100vh]
     items-center" >
